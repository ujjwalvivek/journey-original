...
- An opt-in Web Audio engine with independent Environment, Train, Music, and Voice buses; scene-aware recorded ambience; reactive train, wind, and layered-rain sources; atmospheric filtering and restrained directional stereo; grouped journey/weather cues; smooth automation; on-demand loading; and browser/capture lifecycle handling.
