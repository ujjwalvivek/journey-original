...
- [ ] Blue-hour passage
- [ ] Night-rail passage
- [ ] Optional final/arrival passage
- [ ] Transcript for every recording
- [ ] Alternate takes or clean pickups

Record voice as dry as possible. Reverb should be added by the engine so every line shares the same acoustic world.

## Interface and capture sounds

Use sparingly:

- [ ] Enable-sound confirmation
- [ ] Train start/stop control
- [ ] Polaroid shutter/capture
- [ ] Photograph settling onto the screen
- [ ] Photograph returning to the journey
