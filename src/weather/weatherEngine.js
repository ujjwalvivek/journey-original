...
export const WEATHER_CONTROLS = Object.freeze([
    ...
    {
        key: "cloudThresholdOuter",
        label: "Cloud threshold outer",
        min: 0.015,
        max: 0.06,
        step: 0.005,
    },
    {
        key: "cloudThresholdMiddle",
        label: "Cloud threshold middle",
        min: 0.06,
        max: 0.1,
        step: 0.005,
    },
    {
        key: "cloudThresholdInner",
        label: "Cloud threshold inner",
        min: 0.1,
        max: 0.16,
        step: 0.005,
    },
    {
        key: "cloudThresholdCore",
        label: "Cloud threshold core",
        min: 0.16,
        max: 0.26,
        step: 0.005,
    },
    ...
    { key: "horizonGlow", label: "Horizon glow", min: 0, max: 1, step: 0.01 },
    { key: "lightning", label: "Distant lightning", min: 0, max: 1, step: 0.01 },
    {
    ...
    { key: "snowfall", label: "Snowfall", min: 0, max: 1, step: 0.01 },
    { key: "snowSpeed", label: "Snow speed", min: 0.2, max: 1.5, step: 0.01 },
...
export const BASE_WEATHER = Object.freeze({
    ...
    cloudHeight: 0,
    cloudScale: 1,
    cloudThresholdOuter: 0.04,
    cloudThresholdMiddle: 0.08,
    cloudThresholdInner: 0.12,
    cloudThresholdCore: 0.2,
    turbulence: 1,
    windSpeed: 1,
    windDirection: 1,
    gustiness: 0,
...
const PROPERTY_GROUP = Object.freeze({
    ...
    cloudHeight: "cloud",
    cloudScale: "cloud",
    cloudThresholdOuter: "cloud",
    cloudThresholdMiddle: "cloud",
    cloudThresholdInner: "cloud",
    cloudThresholdCore: "cloud",
    turbulence: "cloud",
    windSpeed: "motion",
...
export const WEATHER_PRESETS = Object.freeze([
    ...
    weatherPreset(
        ...
        {
            precipitation: { delay: 2.5, duration: 7, easing: "smooth" },
            visibility: { delay: 0, duration: 8, easing: "smooth" },
        },
    ),
    weatherPreset(
        "distant-storm",
        "Distant Storm",
        {
            ...
            mistDensity: 0.1,
            mistSpeed: 0.5,
            atmosphericDesaturation: 0.2,
            lightning: 0.92,
            lightScatter: 0.24,
        },
        {
            cloud: { delay: 0, duration: 8, easing: "smooth" },
            visibility: { delay: 2, duration: 9, easing: "smooth" },
        },
    ),
